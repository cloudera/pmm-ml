...
def explain(args):
    args = {k: v for k, v in args.items() if k in set(em.features)}
    data = dict(ChainMap(args, em.default_data))
    data = em.cast_dct(data)
    probability, explanation = em.explain_dct(data)

    return {"data": args, "probability": probability, "explanation": explanation}
...
# 'opp_assists': 30,
# 'opp_blocks': 5,
# 'opp_defensive_rebounds': 30,
# 'opp_field_goal_attempts': 97,
# 'opp_field_goals': 48,
# 'opp_free_throw_attempts': 27,
# 'opp_free_throws': 21,
# 'opp_offensive_rebounds': 15,
# 'opp_personal_fouls': 26,
# 'opp_points': 119,
# 'opp_steals': 10,
# 'opp_three_point_field_goal_attempts': 3,
# 'opp_three_point_field_goals': 1,
# 'opp_total_rebounds': 45,
# 'opp_turnovers': 18,
# 'opp_two_point_field_goal_attempts': 94,
# 'opp_two_point_field_goals': 47,
# 'personal_fouls': 25,
# 'points': 119,
# 'steals': 9,
...
# 'total_rebounds': 44,
# 'turnovers': 19,
# 'two_point_field_goal_attempts': 91,
# 'two_point_field_goals': 46}
#explain(x)
